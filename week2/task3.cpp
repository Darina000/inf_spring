...
auto make_multi_array(const Container & container)
{
    ...
    fill_multi_array < N > (container, std::begin(multi_array)); //вот организовать фил мульти аррай, строк 8,
...
int main(int argc, char ** argv)
{
    ...
    auto multi_array = make_multi_array < int, 3U > (v); //делает бустовский мульти эррей
